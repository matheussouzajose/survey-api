...
import { LoadSurveyResultRepositorySpy } from '@/tests/data/mocks/mock-db-survey-result'
import { LoadSurveyByIdRepositorySpy } from '@/tests/data/mocks/mock-db-survey'
