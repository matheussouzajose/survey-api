...
import { AddUserSpy, AuthenticationSpy } from '@/tests/Presentation/Mocks/UserMock'
import { ValidationSpy } from '@/tests/Presentation/Mocks/ValidationMock'
...
const makeSut = (): SutTypes => {
  ...
  const addAccountSpy = new AddUserSpy()
